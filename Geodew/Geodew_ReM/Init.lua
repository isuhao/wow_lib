...
function Geodew_ReM:Timer()
	if Geodew_ReM.timer ~=nil then
		Geodew_ReM:CancelTimer(Geodew_ReM.timer)
	end
	Geodew_ReM.timer = Geodew_ReM:ScheduleRepeatingTimer("TimerFeedback", Geodew_ReM.db.profile.timer)
end
